...
sub version_from {
    return 'lib/Syntax/Operator/Eqv.pm';
}
...
My::Module::Meta - Information needed to build Syntax::Operator::Eqv
...
This module centralizes information needed to build C<Syntax::Operator::Eqv>. It
is private to the C<Syntax::Operator::Eqv> package, and may be changed or
...
modules required to build the C<Syntax::Operator::Eqv> package, suitable for
...
the modules required to run the C<Syntax::Operator::Eqv>
